...
app.controller('pmrCtrl', function ($scope, actionService,$http) {
	...
	$scope.onSubmit= function () {
		...
		$scope.formData={"actionRowsData": $.param($scope.actions),
						 "risks":$.param($scope.risks),
						"highlights":$.param($scope.allHighlights),
						"milestonesData":$.param($scope.milestones),
						};

	console.log('formData====='+ angular.toJson($scope.formData));
			 $http.post('http://localhost:4400/post', $scope.formData
	...
	$scope.onSubmitRisk = function (risk) {
		...
		$scope.risks.push(angular.copy(risk));
		console.log('$scope.risks====='+ angular.toJson($scope.risks));


			/*  $http.post('http://localhost:4400/post', $scope.risks
             ).success(function(data, status, headers, config) {
              alert("Success!")
             }).error(function(data, status, headers, config) {
               alert("Error");
	...
	$scope.onSubmitMS = function (milestone) {
		$scope.milestones.push(angular.copy(milestone));
		console.log('$scope.milestones====='+ angular.toJson($scope.milestones));


			/*  $http.post('http://localhost:4400/post', $scope.milestones
             ).success(function(data, status, headers, config) {
              alert("Success!")
             }).error(function(data, status, headers, config) {
               alert("Error");
	...
	$scope.onSubmitHighlight = function (highlights) {
		...
		$scope.allHighlights.push(angular.copy(highlights));
		console.log('$scope.highlights====='+ angular.toJson($scope.allHighlights));


			/*  $http.post('http://localhost:4400/post', $scope.allHighlights
             ).success(function(data, status, headers, config) {
              alert("Success!")
             }).error(function(data, status, headers, config) {
               alert("Error");
	...
	$scope.onSaveAction = function (action) {
		
		$scope.actions.push(angular.copy(action));
		console.log('$scope.actions====='+ angular.toJson($scope.actions));


			/*  $http.post('http://localhost:4400/post', $scope.actions
             ).success(function(data, status, headers, config) {
              alert("Success!")
             }).error(function(data, status, headers, config) {
               alert("Error");
